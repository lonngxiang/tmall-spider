    ...
    def parse(self, response):
        ...
        for w in range(len(new_html2['rateDetail']['rateList'])):
            ...
            try:
                ...
                response = requests.post(url="http://service.lavector.com/api/v1/es/bulk/tmall", headers=headers2,
                                         json=cotents_all)
